      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/#quick-verdict" className="hover:text-amber-400 transition-colors">
                  Review
                </Link>
              </li>
              <li>
                <Link href="/#specifications" className="hover:text-amber-400 transition-colors">
                  Specifications
                </Link>
              </li>
              <li>
                <Link href="/#comparison" className="hover:text-amber-400 transition-colors">
                  Comparison
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/deals" className="hover:text-amber-400 transition-colors">
                  Deals
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/terms-conditions" className="hover:text-amber-400 transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
        ...
        <div className="mt-10 pt-6 border-t border-gray-800 text-center text-xs text-gray-500">
          <p className="affiliate-disclosure">
            ...
            <Link href="/affiliate-disclosure" className="underline hover:text-amber-400">
              Learn more
            </Link>
            .
          </p>
